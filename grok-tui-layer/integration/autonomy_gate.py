"""
WORMHOLE-PATH1 | OMEGA-CLASS | prime-crystal-grok/grok-tui-layer/integration/autonomy_gate.py
...
def main():
    ...
    bundle_path = SEED_ROOT / "evidence" / "PC_GROK_EVIDENCE_phase4_3_autonomy_gate.json"
