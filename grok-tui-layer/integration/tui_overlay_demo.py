"""
WORMHOLE-PATH1 | OMEGA-CLASS | prime-crystal-grok/grok-tui-layer/integration/tui_overlay_demo.py
...
def main():
    ...
    bundle_path = SEED_ROOT / "evidence" / "PC_GROK_EVIDENCE_phase5_1_tui_overlay.json"
