"""
WORMHOLE-PATH1 | OMEGA-CLASS | prime-crystal-grok/distillation/__init__.py
Distillation Namespace – Wormhole-Path 2 (Omega Feedback Loop) + Phase 13: The Distillation Crucible & QLoRA Synthesis

Axiomatic Dependencies:
- Wormhole-Path 2: GeometryHarvester capturing (K(S)_problem ↔ K(S)_solution) Shape Pairs with Δλ₁ ≥ 0 for autonomous distillation
- Phase 11/13 MaxOp Hardware Axioms (Operational Blueprint for 8B models on 6GB ARM64+NPU)
- Phase 3 sparse csr_matrix invariants (L_F = δ^T δ zero-copy NPU mapping)
- Phase 4/5/8/9/11 H⁰/H¹/H²/H³ + Continuity Guard + A4 Repair
...
__version__ = "0.1.0-phase13"
__hardware_target__ = "8-core ARM64 + NPU (≤6GB VRAM / UMA)"
__distillation_focus__ = "QLoRA from Shape Pairs → self-improving 8B edge model"
